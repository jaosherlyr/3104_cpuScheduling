...
def get_input():
    ...
    print("\nEnter the ARRIVAL TIME and the BURST TIME of each P (separate with a space):")
...
def fcfs(process_list):
    ...
    for i in range(len(process_list)):
        ...
        turnaround_time = end_time - process_list[i][1]
        waiting_time = turnaround_time - process_list[i][2]

        process_list[i][3:6] = [end_time, turnaround_time, waiting_time]
...
def main():
    ...
    calculated_process = fcfs(process_list)
